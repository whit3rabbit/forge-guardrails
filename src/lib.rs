...
pub use proxy::{
    ...
    handle_anthropic_messages_with_scorers_tool_controls_and_headers, handle_chat_completions,
    ...
    init_proxy_training_capture_sink_from_env, openai_to_messages, respond_tool_openai,
    shutdown_proxy_classifier_log_sink, shutdown_proxy_tool_output_compression_log_sink,
